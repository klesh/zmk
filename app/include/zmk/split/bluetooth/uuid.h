...
#define ZMK_SPLIT_BT_SYNC_OUTPUT_UUID ZMK_BT_SPLIT_UUID(0x00000101)
#define ZMK_SPLIT_BT_SYNC_LAYER_UUID ZMK_BT_SPLIT_UUID(0x00000102)
#define ZMK_SPLIT_BT_SYNC_BATTERY_UUID ZMK_BT_SPLIT_UUID(0x00000103)
